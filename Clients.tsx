...
import { Client, CreateClientModal, DropdownOrderBy, Header, SearchInput } from "../components";
...
export const Clients = () => {
	...
	useEffect(() => {
		...
		setClients(
			(prevState) => 
			orderClients(prevState, currentOrderOption));
	}, []);

	//Funcion para ordernar a los clientes
	const orderClients = (clients : IClient[], currentOrderOption: string): IClient[] => {
